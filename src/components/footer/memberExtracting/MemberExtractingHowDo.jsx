...
import memberExtractingHowImg from "../../../assets/images/MemberExtractingHow.png";
import { Link } from "react-router-dom";

export default function MemberExtractingHowDo() {
  return (
    <div className="w-full ml-2 lg:ml-8 lg:py-28 py-8">
      <div className="flex flex-wrap -mx-6">
        <div className="mb-6 w-full lg:w-1/2 px-6">
          ...
          <ol>
            ...
            <li className="text-gray-700 dark:text-dark-paragraph leading-loose">
              ...
              Wait until full members list is fetched <br />
            </li>
            <li className="text-gray-700 dark:text-dark-paragraph leading-loose">
              {" "}
              <svg
              ...
              Download a CSV or JSON file with all members.
            </li>
          </ol>
        </div>
        <div className="w-full lg:w-1/2 px-6">
          <img
            ...
            src={memberExtractingHowImg}
            alt="how to enable fetching members"
          />
        </div>
      </div>
    </div>
