...
import brandMonitoringHowWorkImg from "../../../../assets/images/brandMonitoringHow3.png";

export default function BrandMonitoringHowItWork() {
  return (
    <div className="max-w-4xl ml-2 lg:ml-8 lg:py-28 py-8">
        ...
        <div className="mb-6 w-full lg:w-1/2 px-6">
          ...
          <ul>
            <li className="text-gray-700 dark:text-dark-paragraph">
              ...
              GroupsTracker.com checks your groups all the time{" "}
            </li>
            <li className="text-gray-700 dark:text-dark-paragraph">
              {" "}
              <svg
              ...
              When a new post or comment is published with a keyword related to
              your brand, you will be notified via email, webhook or Slack.
            </li>
            <li className="text-gray-700 dark:text-dark-paragraph">
              {" "}
              <svg
