...
export default function Review({ review = {} }) {
    ...
    const {name,designation,image,quote}=review

  return (
    <div className="mx-auto py-10 bg-light-tertiary dark:bg-dark-tertiary shadow-xl rounded">
      <div className="max-w-5xl p-4 flex flex-wrap justify-center items-center">
        ...
        <div className="w-full lg:w-2/3">
          <svg
            className="mb-4 text-primary h-10"
            viewBox="0 0 32 28"
            fill="none"
